        ...
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          <View style={styles.hero}>
            ...
            <Text style={styles.tag}>
              Hazard Assessment Road Detection — report it, we'll route it.
            </Text>
          </View>
          ...
          <View style={styles.card}>
            ...
            <Text style={[typography.caption, { marginBottom: spacing.lg }]}>
              Use your HARDA account. Field crew see their team's assignments after sign-in.
            </Text>
            ...
            <PrimaryButton
              title="Continue as guest (report only)"
              onPress={onGuest}
              variant="secondary"
            />
          </View>
          ...
          <View style={styles.footer}>
            <Text style={typography.caption}>No account yet? </Text>
